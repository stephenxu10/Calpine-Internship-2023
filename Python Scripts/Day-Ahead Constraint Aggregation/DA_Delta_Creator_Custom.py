...
json_path = "//pzpwcmfs01/CA/11_Transmission Analysis/ERCOT/10 - Studies/2024/Summer Prep/Extracts/DA Delta" + str(year) + "_web_data.json"
json_summary = "//pzpwcmfs01/CA/11_Transmission Analysis/ERCOT/10 - Studies/2024/Summer Prep/Extracts/DA Delta/processed_" + str(year) + "_summary.json"
delta_path = f"//pzpwcmfs01/CA/11_Transmission Analysis/ERCOT/10 - Studies/2024/Summer Prep/Extracts/DA Delta/Exposure_DAM_{year}_{PATHID}.csv"
